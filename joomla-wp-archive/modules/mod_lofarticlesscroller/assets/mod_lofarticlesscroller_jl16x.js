    ...
    var LofArticleSroller = new Class({
        initialize: function (eMain, eNavigator, eNavOuter, options) {
            ...
            if ($defined(eNavigator) && $defined(eNavOuter)) {
                ...
                this.navigatorFx = new Fx.Morph(eNavigator, modes[this.setting.navigatorAlignment][0], {
				...
				$image.each( function( image, index ){
						if( image.complete ){
							...
							setTimeout( function(){
								var fx = new Fx.Style( image,{ duration:1000} );				 
								fx.start({opacity:[0,1]});
							}, 400)+index*50;	
						}
				});
        ...
        navivationAnimate: function (currentIndex) {
            ...
            this.navigatorFx.cancel().start(-this.setting.startItem * this.setting.navItemHeight);
        },
