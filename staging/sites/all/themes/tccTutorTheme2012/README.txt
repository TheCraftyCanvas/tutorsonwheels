...
tccTutorTheme2012S ARE GO!

tccTutorTheme2012 is a stater sub-theme for Corolla 7.x-2.x and can be easily
...
name from tccTutorTheme2012, then read on.

1. Copy this entire theme and change the name of the folder. Currently the name of the folder
   is "tccTutorTheme2012", so you might choose "bartheme". In the next step we will use this name for
...
2. tccTutorTheme2012.info - first rename this file to match the folder name you chose in step one. Next you
...
4. template.php - open up this file and make some changes - search and replace "tccTutorTheme2012" for your
   themes name.

   In tccTutorTheme2012_preprocess_html() you will find some stuff about responsive stylesheets and IE conditional
